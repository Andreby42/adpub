	...
	protected BaseAdEntity dealEntity(AdCategory cateGory, AdvParam advParam, AdPubCacheRecord cacheRecord,
		...
		if (cateGory == null) {
			...
			for (Map.Entry<Integer, AdContentCacheEle> entry : adMap.entrySet()) {
				...
				if (isRecord) {
					AnalysisLog
							.info("[OPEN_SCREEN_ADS]: adKey=ADV[id={}#showType={}#title={}], userId={}, accountId={}, udid={}, cityId={}, s={}, v={},nw={},ip={},deviceType={},geo_lng={},geo_lat={}",
									entity.getId(), showType.getType(), entry.getValue().getAds().getTitle(),
									advParam.getUserId(), advParam.getAccountId(), advParam.getUdid(),
									advParam.getCityId(), advParam.getS(), advParam.getV(), advParam.getNw(),
		...
		if (cateGory.getAdType() == 1) {
			...
			AnalysisLog
					.info("[NEW_OPEN_SCREEN_ADS]: adKey=ADV[id={}#showType={}#title={}], userId={}, accountId={}, udid={}, cityId={}, s={}, v={},nw={},ip={},deviceType={},geo_lng={},geo_lat={}",
							entity.getId(), showType.getType(), adMap.get(cateGory.getAdId()).getAds().getTitle(),
							advParam.getUserId(), advParam.getAccountId(), advParam.getUdid(), advParam.getCityId(),
		...
		// 开屏的 inmobe
			...
			AnalysisLog
					.info("[NEW_OPEN_SCREEN_ADS]: adKey=ADV[id={}#showType={}#title={}],des={},link={} , userId={}, accountId={}, udid={}, cityId={}, s={}, v={},provider_id={},pic={},nw={},ip={},deviceType={},geo_lng={},geo_lat={}",
							entity.getId(), showType.getType(), apiEntity.getApiTitle(), apiEntity.getApiDes(),
							apiEntity.getLink(), advParam.getUserId(), advParam.getAccountId(), advParam.getUdid(),
...
//		cacheRecord.setOpenAdHistory(cateGory);
	...
	private OpenAdEntity createSDKOpenAds(int adType) {
	    ...
	    entity.setDuration(5);      // 广告持续时间，单位-S
