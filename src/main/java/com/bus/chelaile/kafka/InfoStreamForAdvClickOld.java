...
//
//public class InfoStreamForAdvClickOld {
//
//
...
//	private static final Logger logger = LoggerFactory.getLogger(InfoStreamForAdvClickOld.class);
//
//	private static ExecutorService adClickLogExec = Executors.newFixedThreadPool(5); // 固定5个线程执行解析的任务。
//
//	public InfoStreamForAdvClickOld() {
//	}
//
//
