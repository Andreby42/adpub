...
public class OCSApiUtil {
    ...
    private static final String PROP_OCS_HOST = "ocs.api.host";
    private static final String PROP_OCS_PORT = "ocs.api.port";
    private static final String PROP_OCS_USERNAME = "ocs.api.username";
    private static final String PROP_OCS_PASSWORD = "ocs.api.password";

    private static final int DEFAULT_EXPIRE = 60 * 60;

    protected static final Logger logger = LoggerFactory.getLogger(OCSApiUtil.class);
