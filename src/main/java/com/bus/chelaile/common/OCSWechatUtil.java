...
public class OCSWechatUtil {
    ...
    private static final String PROP_OCS_HOST = "ocs.wechat.host";
    private static final String PROP_OCS_PORT = "ocs.wechat.port";
    private static final String PROP_OCS_USERNAME = "ocs.wechat.username";
    private static final String PROP_OCS_PASSWORD = "ocs.wechat.password";

    private static final int DEFAULT_EXPIRE = 60 * 60;

    protected static final Logger logger = LoggerFactory.getLogger(OCSWechatUtil.class);
    ...
    private static String readHost() {
        ...
        if (StringUtils.isEmpty(result)) {
            logger.error("get config is null ~~~~~~~~~` ");
            return host;
        }
        return result;
    }
