...
public class RedisBUSCacheImplUtil implements ICache {
    private static Logger log = LoggerFactory.getLogger(RedisBUSCacheImplUtil.class);
    ...
    private static String REDIS_HOST = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisBUS.host");
    private static int REDIS_PORT = Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisBUS.port"));
...
//        config.setTestOnReturn(true);
        ...
        log.info("Redis_BUS_CacheImplUtil init success,ip={},host={}", REDIS_HOST, REDIS_PORT);
    }
