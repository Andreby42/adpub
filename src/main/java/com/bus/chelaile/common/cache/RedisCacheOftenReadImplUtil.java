...
public class RedisCacheOftenReadImplUtil implements ICache {
    ...
    private static int REDIS_PORT =
            Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisCount.read.port"));
    private static String REDIS_PASSWORD =
            PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisCount.read.password", "");
