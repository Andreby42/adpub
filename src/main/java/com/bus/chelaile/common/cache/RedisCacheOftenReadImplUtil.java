...
public class RedisCacheOftenReadImplUtil implements ICache{
	private static Logger log = LoggerFactory.getLogger(RedisCacheOftenReadImplUtil.class) ;
...
//	private static final int DEFAULT_REDIS_PORT = 6379;
	...
	private static String REDIS_HOST = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisCount.read.host");
	private static int REDIS_PORT = Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisCount.read.port"));
	private static String REDIS_PASSWORD = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisCount.read.password", "");
