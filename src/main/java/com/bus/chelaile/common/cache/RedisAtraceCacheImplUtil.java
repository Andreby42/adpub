...
public class RedisAtraceCacheImplUtil implements ICache {
    private static Logger log = LoggerFactory.getLogger(RedisAtraceCacheImplUtil.class);
    ...
    private static String REDIS_HOST = PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisAtrace.host");
    private static int REDIS_PORT = Integer.parseInt(PropertiesUtils.getValue(PropertiesName.CACHE.getValue(), "redisAtrace.port"));
