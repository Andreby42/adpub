...
public class BusAdvAction extends AbstractController {
	...
	public String getNewOpenAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
	...
	public String getOpenScreenAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
		param.setType(0);
	...
	public String getFullAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
		param.setType(1);
	...
	public String preloadAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
	...
	public String precacheResource(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
	...
	public String getActiveAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
		param.setType(0);
	...
	public String getRide(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
		param.setType(1);
	...
	public String getWechatAppHomeBanner(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
	...
	public String reloadDatas(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		log.info("reload ******************************");
	...
	public String getSwSwitch(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		log.info("[entergetSwSwitch]");
		String swSwitch = PropertiesUtils.getValue(
				PropertiesName.PUBLIC.getValue(), "swSwitch", "1");
		...
		return serviceManager.getClienSucMap(sw,
	...
	public String uninterest(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
...
//		}
		...
		return serviceManager.uninterest(param, showType, advId, apiType,
				provider_id, secret);
	}
...
//		}
	...
	public String invalidUser(HttpServletRequest request,
		...
		return serviceManager.invalidUser(param, startInvalidDate,
				endInvalidDate);
	...
	public String clearInvalidAds(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
	...
	public String getDisplayAdv(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		AdvParam param = getActionParam(request);
...
//		srcUrl = queryString.split("srcUrl=")[1];
		...
		if (null != goalUrl) {
			log.info("busAdvAction, " + udid + " shortUrl: " + goalUrl
					+ " redirectUrl: " + srcUrlDecode);
			return goalUrl;
		} else {
			log.info("busAdvAction, shortUrl:{}, redirectUrl:{}, failed",
					goalUrl, srcUrlDecode);
			return "生成短链接失败";
		}
	...
	public String setNewUserstoOCS(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		String udid = request.getParameter("udid");
